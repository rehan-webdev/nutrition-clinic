...
import { calendlyUrl, clinic, navLinks } from "@/lib/data";
  ...
  return (
    <a href="#home" className="flex items-center gap-2.5">
      ...
      <span className="leading-tight">
        <span
          className={cn(
            "block font-display text-[21px] font-extrabold tracking-tight",
            light ? "text-white" : "text-[#2E9B4B]",
          )}
        >
          The Nutrition Club Clinic
        </span>
        {/* <span
          className={cn(
