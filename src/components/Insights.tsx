      ...
      <div className="container-x">
        <div className="flex flex-col items-end justify-between gap-8 lg:flex-row">
          <SectionHead
            ...
            highlight="practical"
            copy="Follow The Nutrition Club Clinic for practical nutrition education, healthy meal ideas, client transformations and everyday guidance."
            className="max-w-xl"
          />
          <Reveal>
            <a
              href="https://www.instagram.com/thenutritionclub4/"
              target="_blank"
              rel="noreferrer"
