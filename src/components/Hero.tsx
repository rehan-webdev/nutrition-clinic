...
const HERO_IMG = "/images/main.jpg";
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <Reveal delay={80}>
            <h1 className="mt-6 text-[2.6rem] leading-[1.05] font-extrabold text-ink sm:text-5xl lg:text-[3.65rem]">
              Personalized nutrition. Better{" "}
              <span className="relative inline-block">
                <span className="relative z-10 text-brand-500">health.</span>
                <svg
          ...
          <Reveal delay={150}>
            <p className="mt-6 text-[15.5px] leading-relaxed text-ink-soft">
              At The Nutrition Club Clinic, we believe nutrition should be personalized, practical and sustainable. We help you work towards better health, healthy weight management and improved wellbeing through nutrition that fits your lifestyle.
            </p>
          </Reveal>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm">
                  <div className="flex items-center gap-1 text-leaf-400">
                    ...
                    <span className="ml-1 font-bold text-ink">Trusted care</span>
                  </div>
                  <p className="text-ink-soft">clients served with personalized care</p>
                </div>
              </div>
            </div>
          </Reveal>
        ...
        <Reveal delay={200} className="relative">
          <div className="relative mx-auto max-w-[30rem]">
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] rounded-tr-[6rem] rounded-bl-[6rem] shadow-[0_40px_80px_-40px_rgba(11,31,20,0.55)]">
              ...
              <div className="absolute right-5 bottom-5 left-5 flex items-center gap-3 rounded-2xl bg-white/95 p-3 backdrop-blur">
                ...
                <div className="text-[13px] leading-tight">
                  <p className="font-bold text-ink">In-clinic and online consultations</p>
                  <p className="text-ink-soft">Personalized support, wherever you are</p>
                </div>
              </div>
            </div>
            ...
            <div className="animate-float absolute -top-6 -left-4 w-52 rounded-2xl border border-brand-50 bg-white p-4 shadow-[0_24px_50px_-28px_rgba(11,31,20,0.6)] sm:-left-10">
              ...
              <p className="mt-2 text-[11px] text-ink-soft">Guidance built around your life</p>
            </div>
            ...
            <div className="animate-float-slow absolute -right-3 bottom-24 w-48 rounded-2xl border border-brand-50 bg-white p-4 shadow-[0_24px_50px_-28px_rgba(11,31,20,0.6)] sm:-right-8">
              <div className="flex items-center gap-2">
                ...
                <div className="leading-tight">
                  <p className="text-[11px] text-ink-soft">Clients served</p>
                  <p className="text-base font-extrabold text-ink">1000+</p>
                </div>
              </div>
              ...
              <p className="mt-2 text-[11px] text-ink-soft">Every journey is different</p>
            </div>
          </div>
        </Reveal>
      </div>
