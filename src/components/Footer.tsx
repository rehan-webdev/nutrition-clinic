...
import { calendlyUrl, clinic, navLinks, programs } from "@/lib/data";
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1.1fr_1fr]">
          <div>
            <h2 className="text-3xl leading-tight font-extrabold text-white sm:text-4xl">
              Practical nutrition guidance <br className="hidden sm:block" /> for everyday wellbeing.
            </h2>
            <p className="mt-3 max-w-lg text-[14.5px] text-white/80">
              Explore practical nutrition education, healthy meal ideas, health tips and clinic updates.
            </p>
          </div>
          ...
          <form onSubmit={submit} className="w-full">
            ...
            <p className="mt-3 pl-1 text-[12px] text-white/70">
              Follow The Nutrition Club Clinic: @thenutritionclub4
            </p>
          </form>
        </div>
      </div>
...
const socials = [
  { label: "Instagram", href: "https://www.instagram.com/thenutritionclub4/" },
];
      ...
      <footer className="relative overflow-hidden bg-ink pt-20 pb-8 text-white">
        ...
        <div className="container-x relative">
          <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
            <div>
              <div className="flex items-center gap-2.5">
                <img src="/images/logo.png" alt="The Nutrition Club Clinic" className="h-11 w-11 object-contain" />
                <span className="leading-tight">
                  <span className="font-display block text-[17px] font-extrabold">The Nutrition Club Clinic</span>
              ...
              <p className="mt-5 max-w-sm text-[13.5px] leading-relaxed text-white/60">
                Personalized nutrition support for metabolic, hormonal, digestive and therapeutic health needs.
              </p>
            ...
            <div>
              ...
              <ul className="mt-5 space-y-3 text-[13.5px] text-white/60">
                ...
                <li>
                  <a href={calendlyUrl} target="_blank" rel="noreferrer" className="transition hover:text-leaf-300">
                    Book Appointment
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-5 space-y-4 text-[13.5px] text-white/60">
                ...
                <li className="flex gap-3"><Icon.Phone className="mt-0.5 h-4 w-4 shrink-0 text-leaf-400" /> {clinic.phone}</li>
                <li className="flex gap-3"><Icon.Phone className="mt-0.5 h-4 w-4 shrink-0 text-leaf-400" /> PTCL: {clinic.ptcl}</li>
                <li className="flex gap-3">
                  <Icon.Mail className="mt-0.5 h-4 w-4 shrink-0 text-leaf-400" /> {clinic.email}
                </li>
                <li className="flex gap-3">
                  <Icon.Instagram className="mt-0.5 h-4 w-4 shrink-0 text-leaf-400" />
                  <a href="https://www.instagram.com/thenutritionclub4/" target="_blank" rel="noreferrer" className="transition hover:text-leaf-300">
                    {clinic.instagram}
                  </a>
                </li>
              </ul>
          ...
          <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-7 text-[12.5px] text-white/45 sm:flex-row">
            <p>
              © {new Date().getFullYear()} The Nutrition Club. All rights reserved. Crafted with ❤️ by{" "}
              <a href="https://devloop.site" target="_blank" rel="noreferrer" className="font-bold text-amber-300 transition hover:text-amber-200">
                Devloop
              </a>
            </p>
