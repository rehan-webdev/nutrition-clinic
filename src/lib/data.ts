...
export const highlights: { icon: IconName; title: string; copy: string }[] = [
  { icon: "Users", title: "Personalized", copy: "Built around your goals." },
  { icon: "Apple", title: "Practical", copy: "Simple everyday strategies." },
  { icon: "Leaf", title: "Sustainable", copy: "Progress without quick fixes." },
  { icon: "Heart", title: "Home-food friendly", copy: "Nutrition for real life." },
];
...
export const programs: {
...
}[] = [
  {
    ...
    copy: "Weight loss, gain and maintenance support.",
    points: ["Weight loss", "Healthy weight gain", "Portion guidance"],
  ...
  },
  {
    ...
    copy: "Support for blood sugar and metabolic health.",
    points: ["Diabetes support", "Prediabetes", "Liver and cholesterol care"],
  ...
  },
  {
    ...
    copy: "Nutrition for PCOS and hormonal wellbeing.",
    points: ["PCOS nutrition", "Hormonal support", "Menstrual health"],
    duration: "Personalized",
    from: "Book a consultation",
  },
  {
    ...
    copy: "Practical support for comfortable digestion.",
    points: ["IBS support", "Bloating", "Constipation"],
    duration: "Personalized",
    from: "Book a consultation",
  },
  {
    ...
    copy: "Tailored nutrition for clinical conditions.",
    points: ["Meal planning", "Nutrition counseling", "Follow-up support"],
    duration: "Condition-specific",
    from: "Book a consultation",
  },
  {
    ...
    copy: "Nutrition for energy, workouts and fitness.",
    points: ["Energy support", "Workout nutrition", "Lifestyle guidance"],
    duration: "Personalized",
    from: "Book a consultation",
  },
  {
    icon: "Users",
    title: "1:1 Personalized Nutrition Coaching",
    copy: "One-on-one guidance, accountability, follow-ups and personalized adjustments throughout your journey.",
    points: ["One-on-one guidance", "Accountability", "Follow-ups and adjustments"],
    duration: "Personalized",
    from: "Book a consultation",
  },
];
